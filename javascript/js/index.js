...
var temp = 5;
if (temp > 0) {
    var temp = 1; //reuses global variable temp
    temp++;
}
...
let temp2 = 5;
if (temp2 > 0) {
    let temp2 = 1; //creates new variable diff from global
    temp2++;
}
...
emptyArray.push(10); //can hold different variable types
...
console.log("nums array has %d items", nums.length); //%d is number placeholder
...
let courses = ["INFO 343", "INFO 340", "TAGALOG 101"];
...
//as the expression
let key = "firstName";
console.log("firstname: ", player[key]);
...
console.log("player email is: ", player["email"]);
...
let keys = Object.keys(player); //array of keys in player
